...
class faceverification2 extends StatefulWidget {
  const faceverification2({super.key});

  @override
  State<faceverification2> createState() => _faceverification2State();
}

class _faceverification2State extends State<faceverification2> {
    ...
    try {
      ...
      if (_faceDetected) {
        ...
        if (distance <= circleRadius){
          ...
          print("Detected Face Contour Data: $detectedContourData");
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(isSuccess ? "Checking Out at: $currentDateTime" : "Face verification failed."),
          actions: <Widget>[
            TextButton(
              child: Text("okay"),
              onPressed: () {
